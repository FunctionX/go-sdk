...
import (
	...
	abci "github.com/functionx/go-sdk/tendermint/abci"
	io "io"
	math "math"
	math_bits "math/bits"
	reflect "reflect"
...
type TxResponse struct {
	...
	Events []abci.Event `protobuf:"bytes,13,rep,name=events,proto3" json:"events"`
}
...
type Result struct {
	...
	Events []abci.Event `protobuf:"bytes,3,rep,name=events,proto3" json:"events"`
	// msg_responses contains the Msg handler responses type packed in Anys.
	//
	// Since: cosmos-sdk 0.46
	MsgResponses []*Any `protobuf:"bytes,4,rep,name=msg_responses,json=msgResponses,proto3" json:"msg_responses,omitempty"`
}
...
func (m *TxMsgData) GetMsgResponses() []*Any {
	if m != nil {
...
var fileDescriptor_4e37629bc7eb0df8 = []byte{
	...
	,
}
...
func (this *TxMsgData) String() string {
	...
	for _, f := range this.MsgResponses {
		repeatedStringForMsgResponses += strings.Replace(fmt.Sprintf("%v", f), "Any", "Any", 1) + ","
	}
...
func (m *TxResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			...
			m.Events = append(m.Events, abci.Event{})
